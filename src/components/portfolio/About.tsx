...
export function About() {
  ...
  return <section id="about" className="py-24 md:py-32" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-muted">
              <img alt="Portrait" className="w-full h-full object-cover" src="../src/components/portfolio/img/nour-el-img-1.jpeg" />
            </div>
            {/* Decorative element */}
          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                With over 6 years of experience in UI/UX design and frontend development, 
                I specialize in creating intuitive digital experiences that bridge the gap 
                between user needs and business goals.
              </p>
              <p>
                My approach combines research-driven design thinking with clean, efficient 
                code to deliver products that not only look beautiful but perform flawlessly. 
                I believe that great design should be invisible, it should feel natural and 
                effortless to users.
              </p>
              <p>
